    ...
    <header className="pt-4 pb-4 z-10 text-white bg-transparent w-full">
      <div className="flex justify-between mx-auto items-center max-w-6xl pl-3">
        ...
        <form className="pl-2 pr-2 mr-2 rounded-lg flex items-center relative">
          <input
            className="w-20 sm:w-64 pb-2 pt-2 border-transparent border-b-2 bg-transparent relative focus:bg-slate-900 focus:outline-none focus:border-white focus:border-b-2 text-sm sm:text-sm hover:border-b-2 hover:border-white"
            type="text"
            placeholder="Search..."
          />
